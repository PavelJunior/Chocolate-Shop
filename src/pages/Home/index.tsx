...
const Home: React.FC = () => {
  const products = [
    {
      ...
      imageUrl: 'https://chocolatecoveredkatie.com/wp-content/uploads/2020/08/Homemade-Chocolate-Bars.jpg',
    },
    {
      id: 2,
      price: 19.99,
  ...
  const items = products.map((item) => {
    ...
    <Grid item xs={4} key={item.id}>
      <HomeItem  description={item.description} name={item.name} imageUrl={item.imageUrl} price={item.price}/>
    </Grid>
    )
  })
